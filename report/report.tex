...
\HRule \\[0.4cm]
{ \LARGE \bfseries Approximating Walrasian Equilibrium with Decentralized Bilateral Trade}\\[0.3cm] % Title of your document
\HRule \\[2cm]
...
% TODO: Give an actual (but informal) definition of a "Walsrian equilibrium"
...
% TODO: Is antisymmetric the right word here?
...
% TODO: Again, it would help if you explicitly stated your intent in I implementing into this algorithm. 
...
% The geometric mean has the nice property of being symmetrical between buying and selling. 
...
\begin{figure}[H]
  ...
  \begin{subfigure}{.4\linewidth}\centering
    \begin{tikzpicture} 
      ...
      \end{axis}
    \end{tikzpicture}  
    \caption{With constraint at 0.7}
  \end{subfigure}%
  
  \caption{
    Wealth
    % TODO: explain wealth diagram
  }
  \label{fig:wealth}
\end{figure}
...
%TODO: rerun with larger trial size
